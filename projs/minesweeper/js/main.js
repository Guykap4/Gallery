...
// CR: Hey Guy! Awesome project. I liked reviewing your code, it seems like you have a great understanding of the material.
// You could use better names for your functions and variables. Also, pay close attention to the PDF,
// there's a table with almost all global variables names given to you. Same for the functions.
// Remember to not repeat yourself.
// Overall your code is clean and you've achieved quite a lot in this sprint. I've added some comments in this file and the utils file. Search for "CR".
// Good Luck!
...
function victorySequence() { // CR: I don't know how I feel about the name, you could've used a better name
    gGame.isOn = false;
...
function safeClick() {
    ...
    setTimeout(function () {elCurrCell.style.backgroundColor = '#42396d';}, 1000, elCurrCell);
    renderSafeClick();
}
